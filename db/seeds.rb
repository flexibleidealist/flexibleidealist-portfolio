...
p1 = Project.create!(title: "NYC Beach App", description: "NYC Beach App consumes third-party APIs to display location and accessibility information for NYC beaches and get current weather conditions.", repo_url: "https://github.com/flexibleidealist/NYC-Beach-App", deployed_url: "nyc-beach-app.netlify.app", image_url: "https://i.imgur.com/rYphrMd.png")
