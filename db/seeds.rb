...
p2 = Project.create!(title: "tiny library", description: "tiny library is a React app that creates a catalogue for free, neighborhood libraries. Users can view the catalogues for library locations, add & delete records when they donate or take books. Built with React, CSS, and Airtable.", deployed_url: "https://tiny-library.netlify.app/", repo_url: "https://github.com/flexibleidealist/tiny-library", image_url: "https://i.imgur.com/UrRcBBH.png")
