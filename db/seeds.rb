...
p1 = Project.create!(title: "NYC Beach App", description: "NYC Beach App consumes third-party APIs to display location and accessibility information for NYC beaches and get current weather conditions.", repo_url: "https://github.com/flexibleidealist/NYC-Beach-App", deployed_url: "https://nyc-beach-app.netlify.app", image_url: "https://i.imgur.com/rYphrMd.png")
p2 = Project.create!(title: "tiny library", description: "tiny library is a React app that creates a catalogue for free, neighborhood-based libraries with an Airtable database. Users can view the current catalogues for tiny library locations, add records when the donate books, and delete records when the take books.", deployed_url: "https://tiny-library.netlify.app/", repo_url: "https://github.com/flexibleidealist/tiny-library", image_url: "https://i.imgur.com/UrRcBBH.png")
p3 = Project.create!(title: "B-Side Collective", description: "B-Side Collective is an online marketplace for buying and selling vinyl records with full CRUD and user authentication. Users can browse and search a selection of records, add records to a shopping cart, and post items for sale.", repo_url: "https://github.com/flexibleidealist/b-side-collective/tree/main", deployed_url: "https://b-side-collective.netlify.app/", image_url: "https://i.imgur.com/xMVnWir.png")
p4 = Project.create!(title: "ArtSpace", description: "ArtSpace is a full-stack app where artists curate online shows of their work. Full CRUD and authentication allow users to update show information, add and remove works, and update profile information.", repo_url: "https://github.com/flexibleidealist/Art-Space", deployed_url: "https://myartspace.netlify.app/", image_url: "https://i.imgur.com/2IKFCT8.png" )
